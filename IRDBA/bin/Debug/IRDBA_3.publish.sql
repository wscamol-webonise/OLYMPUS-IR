...
GO
PRINT N'Creating Table [dbo].[LPInvestment]...';
...
CREATE TABLE [dbo].[LPInvestment] (
    ...
    CONSTRAINT [PK_LPInvestmentID] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];


GO
PRINT N'Creating Table [dbo].[LPInvestmentContact]...';
...
CREATE TABLE [dbo].[LPInvestmentContact] (
    ...
    CONSTRAINT [PK_InvestmentContactID] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY] TEXTIMAGE_ON [PRIMARY];


GO
PRINT N'Creating Table [dbo].[LPInvestmentContactNote]...';
...
CREATE TABLE [dbo].[LPInvestmentContactNote] (
    ...
    [UpdateNode]              NVARCHAR (32) NULL,
    [InvestorID]              INT           NULL,
    CONSTRAINT [PK_InvestmentContactNoteID] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY];
