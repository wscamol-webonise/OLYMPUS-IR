...
GO
PRINT N'Creating Table [dbo].[InvestorType]...';
...
CREATE TABLE [dbo].[InvestorType] (
    ...
    CONSTRAINT [PK_InvestorTypeID] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 90) ON [PRIMARY],
    CONSTRAINT [UK_InvestorType] UNIQUE NONCLUSTERED ([Name] ASC) WITH (FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY];
