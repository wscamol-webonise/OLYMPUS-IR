...
GO
PRINT N'Creating Table [dbo].[InvestorContactLegalEntity]...';
...
CREATE TABLE [dbo].[InvestorContactLegalEntity] (
    ...
    CONSTRAINT [PK_InvestorContactLegalEntity] PRIMARY KEY CLUSTERED ([ID] ASC) WITH (FILLFACTOR = 90) ON [PRIMARY],
    CONSTRAINT [UK_InvestorContactLegalEntity] UNIQUE NONCLUSTERED ([InvestorLegalEntityID] ASC, [InvestorContactID] ASC) WITH (FILLFACTOR = 90) ON [PRIMARY]
) ON [PRIMARY];
